...
class SocialPostDetailsView: UIView {
    ...
    func configureCalendarView(socialPost: CalendarSocialPost) {
        scheduleTimeLabel.text = formatDate(date: socialPost.scheduledDate!)
        recommendedLabel.text = socialPost.text
        titleLabel.text = socialPost.title
        postUrl.text = socialPost.url
    }
    ...
    private func loadNib() {
        Bundle.main.loadNibNamed("SocialPostDetailsView", owner: self, options: nil)
