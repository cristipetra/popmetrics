...
class TrafficReportViewController: UIViewController {
    ...
    func addPageView() {
        ...
        statsPageVC.view.heightAnchor.constraint(equalToConstant: 958).isActive = true
        
        
        //statsPageVC.view.bottomAnchor.constraint(equalTo: self.containerView.bottomAnchor, constant: 10).isActive = true
