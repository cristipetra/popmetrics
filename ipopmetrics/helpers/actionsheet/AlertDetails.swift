...
open class TwitterActionController: ActionController<TwitterCell, ActionData, TwitterActionControllerHeader, String, UICollectionReusableView, Void> {
    ...
    lazy var hideBottomSpaceView: UIView = {
        ...
        let height = contentHeight + TwitterActionController.bottomPadding
    ...
    override open func viewSafeAreaInsetsDidChange() {
        ...
        hideBottomSpaceView.frame.size.height = contentHeight + TwitterActionController.bottomPadding
        hideBottomSpaceView.frame.size.width = collectionView.bounds.width
    }
