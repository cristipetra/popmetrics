...
open class ActionDetailsCell: ActionCell {
...
open class DetailsActionController: ActionController<ActionDetailsCell, ActionData, ActionControllerHeader, String, UICollectionReusableView, Void> {
    ...
    lazy var hideBottomSpaceView: UIView = {
        ...
        let height = contentHeight + DetailsActionController.bottomPadding + safeAreaInsets.bottom
    ...
    public override init(nibName nibNameOrNil: String? = nil, bundle nibBundleOrNil: Bundle? = nil) {
        ...
        cellSpec = CellSpec.nibFile(nibName: "ActionDetailsCell", bundle: Bundle(for: ActionDetailsCell.self), height: { _ in 56 })
    ...
    override open func viewSafeAreaInsetsDidChange() {
        ...
        hideBottomSpaceView.frame.size.height = contentHeight + DetailsActionController.bottomPadding + safeAreaInsets.bottom
