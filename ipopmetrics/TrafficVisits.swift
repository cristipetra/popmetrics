...
class TrafficVisits: UIView {
    ...
    //  var firstProgressValue = 0 {
    //    didSet{
    //
    //    }
    //
    //  }
    //  var secondProgressValue = 0 {
    //    didSet {
    //
    //    }
    //  }
    ...
    func setUpVisitsView() {
        ...
        firstProgressView.backgroundColor = UIColor(red: 196/255, green: 13/255, blue: 72/255, alpha: 1)
        ...
        secondProgressView.backgroundColor = UIColor(red: 255/255, green: 34/255, blue: 194/255, alpha: 1)
