...
class ConciergeChatViewController: BaseChatViewController {
    ...
    override func viewDidLoad() {
        ...
        let addIncomingMessageButton = UIBarButtonItem(image: image, style: .plain, target: self, action: #selector(ConciergeChatViewController.addRandomIncomingMessage))
